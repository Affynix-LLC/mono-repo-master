...
1. **Navigate to the agents directory:**
   ```bash
   cd affynix_ai_website/website_build/affynix_agent_sales_build/affynix
   ```
...
2. **Deploy to Vercel:**
   ...
   - Root Directory: `affynix_ai_website/website_build/affynix_agent_sales_build/affynix`
